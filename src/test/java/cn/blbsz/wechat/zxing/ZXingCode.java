...
//      String filePath = request.getSession().getServletContext().getRealPath("/") + "resources/images/logoImages/llhlogo.png";
        ...
        String filePath = "src\\test\\java\\cn\\blbsz\\wechat\\zxing\\bg_img.jpg";  //TODO
...
//            String imageBase64QRCode =  Base64.byteArrayToBase64(baos.toByteArray());
            String imageBase64QRCode =  new Base64().encodeAsString(baos.toByteArray());
            baos.close();
    ...
    public BufferedImage getQR_CODEBufferedImage(String content, BarcodeFormat barcodeFormat, int width, int height, Map<EncodeHintType, ?> hints)
    {
        ...
        try {
            ImageIO.write(image, "jpg", new File("result6.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        return image;
